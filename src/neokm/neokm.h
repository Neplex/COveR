...
double neo_withinss(double **elements, double **centers, bool **asso,
...
void neo_assign(double **elements, double **centers, bool **asso,
  ...
  neo_withinss(elements, centers, asso, nb_elements, nb_clusters, nb_dim,
               withinss);
}
...
void neokm(double **elements, double **centers, bool **asso,
           unsigned nb_elements, unsigned nb_clusters, unsigned nb_dim,
           double alpha, double beta, Distance dist, bool trace,
           unsigned max_iter, double *withinss, double *tot, double *totwss,
           unsigned short *iter) {
  ...
  *totwss = INFINITY;
  ...
  do {
    ...
    // Update all centers
    neo_update(elements, centers, asso, nb_elements, nb_clusters, nb_dim, alpha,
               beta, withinss);
